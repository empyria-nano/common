import { enumise } from '@principia/classification'

import Clerobee from 'clerobee'
import { BaseErrors } from './Errors.js'

const clerobee = new Clerobee(process.env.PRINCIPIA_ID_LENGTH || 32)
 ...
 * @throws {PrincipiaError} `BaseErrors.UnrecognisedType` if `type` isn't one of {@link CODOGRAM_LIST}.
 */
