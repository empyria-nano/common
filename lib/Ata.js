...
export function validate(schema, input) {
	const validateInput = createValidator(schema)
 ...
 * @returns {Object} Enum schema over `'production' | 'development' | 'local'`.
 */
export function nodeEnv() {
	return enumType(['production', 'development', 'local'], 'local')
}
